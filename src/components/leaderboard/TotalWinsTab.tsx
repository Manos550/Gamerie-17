...
export default function TotalWinsTab({ entities, entityType }: { entities: any[]; entityType: 'users' | 'teams' }) {
  return (
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-white">{entity.stats.wins}</div>
